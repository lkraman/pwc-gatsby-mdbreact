...
export const FullMenuPage = () => (
  <Layout pageInfo={{ pageName: "fullmenu" }}>
    ...
    <h2 className="menuHeader h1-responsive font-weight-b text-center my-5">
      Our Menu
    </h2>
    ...
    <MDBRow className="d-flex p-2 justify-content-center">
      <div className="d-flex w-70 p-2 text-center">
        <MDBCol>
          <MDBCard>
            <MDBCardBody>
              <h3 className="card_title font-weight-b">OMELETTES</h3>
              <p className="small">
                (Served with home fries and toast or English muffin)
              </p>
              <span className="float-right font-weight-b">$6.99</span>
              <h6 className="menu-item">Cheese</h6>
              <span className="float-right font-weight-b">$8.50</span>
              ...
              <span className="float-right font-weight-b">$9.50</span>
              ...
              <h3 className="card_title font-weight-b">BREAKFAST SANDWICHES</h3>
              <br />
              <span className="float-right font-weight-b">$3.99</span>
              ...
              <br />
              <h3 className="card_title font-weight-b">COMFORT FOOD</h3>
              <br />
              <span className="float-right font-weight-b">$6.99</span>
              <h6 className="menu-item">Cream Chipped Beef </h6>
              <p className="menu-desc"> Served on home fries OR toast</p>
              <span className="float-right font-weight-b">$7.99</span>
              <h6 className="menu-item">Biscuits and Gravy </h6>
              <p className="menu-desc">Served with home fries</p>
              <br />
              <h3 className="card_title font-weight-b">BREAKFAST SIDES</h3>
              <br />
              <span className="float-right font-weight-b">$1.39</span>
              <h6 className="menu-item">One Egg</h6>
              <span className="float-right font-weight-b">$1.89</span>
              <h6 className="menu-item">Home Fries</h6>

              <span className="float-right font-weight-b">$1.49</span>
              <h6 className="menu-item">Toast or English muffin</h6>
              <p className="menu-desc"> White, Multi-grain, Rye </p>
              <span className="float-right font-weight-b">$2.50</span>
              ...
              <h3 className="card_title font-weight-b">EGGS BENEDICT</h3>
              <p className="small">
                (Served on English muffin with home fries)
              </p>
              <span className="float-right font-weight-b">$8.99</span>
              <h6 className="menu-item">Classic</h6>
              <p className="menu-desc">
                {" "}
                Poached egg*, Canadian bacon, hollandaise sauce
              </p>
              <span className="float-right font-weight-b">$10.99</span>
              ...
              <h3 className="card_title font-weight-b">
              ...
              <p className="menu-desc">
                ...
                <br /> <b>Regular: </b>Full stack (3) $7.99 | Short stack (2)
                $6.99 | 1 pancake $5.00{" "}
              </p>
              ...
              <span className="float-right font-weight-b">$5.99</span>
              ...
              <br />
              <p className="warning small font-weight-b">
    ...
    <MDBRow className="d-flex p-2 justify-content-center">
      <div className="d-flex w-70 p-2 text-center">
        <MDBCol>
          <MDBCard>
            <MDBCardBody>
              <h3 className="card_title font-weight-b">SOUP & SALADS</h3>
              ...
              <span className="float-right font-weight-b">$12.45</span>
              ...
              <span className="float-right font-weight-b">$5.25</span>
              ...
              <br />
              <h4 className="card_title font-weight-b">TACOS:</h4>
              <p className="small">
              ...
              <br />
              <h4 className="card_title font-weight-b">QUESADILLAS:</h4>
              <p className="small">
              ...
              <span className="float-right font-weight-b">$13.99</span>
              <h6 className="menu-item">Shrimp</h6>

              <br />
              <h4 className="card_title font-weight-b">AREPAS:</h4>
              ...
              <br />
              <h3 className="card_title font-weight-b">WRAPS</h3>
              <p className="small">
              ...
              <h3 className="card_title font-weight-b">FROM THE GRILL</h3>
              <p className="small">
              ...
              <span className="float-right font-weight-b">$6.45</span>
              <h6 className="menu-item">Grilled Cheese with Ham or Bacon</h6>
              <p className="menu-desc">On your choice of bread</p>
              <span className="float-right font-weight-b">$9.25</span>
              ...
              <br />
              <h3 className="card_title font-weight-b">COLD SANDWICHES</h3>
              <p className="small">
                (Served with chips. Substitute Fries or Onion Rings add $1.00)
              </p>
              <span className="float-right font-weight-b">$8.25</span>
              ...
              <span className="float-right font-weight-b">$8.49</span>
              ...
              <span className="float-right font-weight-b">$11.45</span>
              <h6 className="menu-item">Bacon Cheeseburger</h6>
              <p className="menu-desc">
                Melted white American cheese and peppered bacon
              </p>
              <span className="float-right font-weight-b">$14.99</span>
    ...
    <MDBRow className="d-flex p-2 justify-content-center">
      <div className="d-flex w-70 p-2 text-center">
        <MDBCol>
          <MDBCard>
            <MDBCardBody>
              <h3 className="card_title font-weight-b">ENTREES</h3>
              ...
              <span className="float-right font-weight-b">$13.45</span>
              ...
              <br />
              <h3 className="card_title font-weight-b">STEAKS</h3>
              <p className="small">(Served with a choice of two sides)</p>
              <span className="float-right font-weight-b">$18.99</span>
              <h6 className="menu-item">Angus Choice NY Strip Steak 10 oz</h6>

              <span className="float-right font-weight-b">$20.99</span>
              <h6 className="menu-item">Angus Choice Beef Filet 8 oz</h6>

              <span className="float-right font-weight-b">$17.99</span>
              <h6 className="menu-item">Lamb</h6>

              <span className="float-right font-weight-b">$16.99</span>
              ...
              <h3 className="card_title font-weight-b">SIDES</h3>
              <br />
              <span className="float-right font-weight-b">$3.50</span>
              ...
              <span className="float-right font-weight-b">$2.00</span>
              <h6 className="menu-item">Garlic Bread</h6>

              <span className="float-right font-weight-b">$3.50</span>
              <h6 className="menu-item">Mashed Potatoes</h6>

              <span className="float-right font-weight-b">$7.45</span>
              <h6 className="menu-item">Chicken Fingers</h6>
              <span className="float-right font-weight-b">$2.99</span>
    ...
    <MDBRow className="d-flex p-2 justify-content-center">
      <div className="d-flex w-70 p-2 text-center">
        <MDBCol>
          <MDBCard>
            <MDBCardBody>
              <h3 className="card_title font-weight-b">BREAKFAST</h3>
              <br />
              <span className="float-right font-weight-b">$3.50</span>
              <h6 className="menu-item">Silver Dollar Pancakes (4)</h6>
              <span className="float-right font-weight-b">$5.50</span>
              ...
              <span className="float-right font-weight-b">$1.00</span>
              <h6 className="menu-item">Kids Side Meat</h6>
              <span className="float-right font-weight-b">$3.99</span>
              <h6 className="menu-item">Cereal</h6>

              <br />
              <h3 className="card_title font-weight-b">LUNCH</h3>
              <br />
              <span className="float-right font-weight-b">$4.50</span>
    ...
    <div className="d-flex w-70 p-2 text-center">
      <MDBCol>
        <MDBCard>
          <MDBCardBody>
            {/* <span className="float-right font-weight-b">$0.00</span> */}
